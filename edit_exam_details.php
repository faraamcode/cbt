...
<label for="default" class="col-sm-2 control-label">Time Duration</label>
 <div class="col-sm-10">
 <input type="number" name="time_for_exam" class="form-control" required="required" maxlength="4" value="<?php echo $exam_time; ?>">
</div></div>
...
<label for="default" class="col-sm-2 control-label">Number of Questions</label>
 <div class="col-sm-10">
 <input type="number" name="total_question_no" class="form-control" required="required" maxlength="4" value="<?php echo $question_no; ?>">
</div></div>
...
<label for="default" class="col-sm-2 control-label">Instructions and Passage</label>
 <div class="col-sm-10">
 <textarea name="instructions" class="form-control" required="required"> <?php echo $instructions; ?>
 </textarea>
</div></div>
