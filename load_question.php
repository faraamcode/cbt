...
$count_set =  mysqli_num_rows($result);
...
<html lang="en">
  ...
  <?php include('includes/topbar.php');?> 
    ...
    <h5> Number of Questions set : <?php echo $count_set; ?> </h5>
...
<label for="default" class="col-sm-2 control-label">OPTION A</label>
 <div class="col-sm-10">
 <textarea name="A" class="form-control" required="required">
 </textarea>
</div></div>
...
<label for="default" class="col-sm-2 control-label">OPTION B</label>
 <div class="col-sm-10">
 <textarea name="B" class="form-control" required="required">
 </textarea>
</div></div>
<div class="form-group">
<label for="default" class="col-sm-2 control-label">OPTION C</label>
 <div class="col-sm-10">
 <textarea name="C" class="form-control" required="required">
 </textarea>
</div></div>
...
<label for="default" class="col-sm-2 control-label">OPTION D</label>
 <div class="col-sm-10">
 <textarea name="D" class="form-control" required="required">
 </textarea>
</div></div>
