         ...
         <div class="card">
           ...
           <?php 
            ...
            while ($rows = mysqli_fetch_array($query)) {
              ?>
              <div class="card-body">
                <input type="radio" name="examcheck[<?php echo $i; ?>]" value="<?php echo $rows['id']; ?>">  <?php echo $rows['answer']; ?>
...
var apiKey = "46968714";
var sessionId = "1_MX40Njk2ODcxNH5-MTYwMzg3NjY5MzY4OH5QUVRuR3NzRG5HbGJvSkhheHZXR2lJNHh-fg";
var token = "T1=="
